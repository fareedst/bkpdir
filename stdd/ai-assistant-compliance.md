...
1. **Requirements Tokens** `[REQ:IDENTIFIER]`
   ...
   - Must reference tokens defined in `stdd/requirements.md`
...
2. **Architecture Tokens** `[ARCH:IDENTIFIER]`
   ...
   - Must reference tokens defined in `stdd/architecture-decisions.md`
...
- Registry validation: Ensures tokens are documented in `stdd/semantic-tokens.md`
...
- Requirements **MUST** be documented in `stdd/requirements.md`

### Architecture Documentation

- All architecture decisions **MUST** have `[ARCH:IDENTIFIER]` tokens
- Architecture decisions **MUST** cross-reference `[REQ:*]` tokens
- Architecture decisions **MUST** be documented in `stdd/architecture-decisions.md`
...
- Implementation decisions **MUST** be documented in `stdd/implementation-decisions.md`
...
- Tasks **MUST** be documented in `stdd/tasks.md`
...
4. Ensure all tokens are documented in `stdd/semantic-tokens.md`
...
2. **Read Documentation**: Review `stdd/ai-principles.md` and `stdd/semantic-tokens.md`
...
- [ ] All tokens documented in `stdd/semantic-tokens.md`
...
- `stdd/ai-principles.md` - Complete AI-first principles and process guide
- `stdd/semantic-tokens.md` - Central registry of all semantic tokens
- `stdd/requirements.md` - Requirements with `[REQ:*]` tokens
- `stdd/architecture-decisions.md` - Architecture decisions with `[ARCH:*]` tokens
- `stdd/implementation-decisions.md` - Implementation decisions with `[IMPL:*]` tokens
- `stdd/tasks.md` - Active task tracking

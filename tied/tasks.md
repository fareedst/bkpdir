...
- [x] Documentation plan specifies updates for `tied/semantic-tokens.md`, `tied/architecture-decisions.md`, or `tied/implementation-decisions.md`
...
- [x] Draft STDD documentation updates for `tied/semantic-tokens.md`, `tied/implementation-decisions.md`, and `tied/architecture-decisions.md` reflecting added tokens
- [x] Mark task complete and summarize audit findings

**Completion Criteria**:
- [x] Each large module has a token coverage summary
- [x] All applied token annotations are registered in `tied/semantic-tokens.md`
...
**Description**: Consolidate the legacy `project-tokens.yaml` registry into `tied/semantic-tokens.md`, ensuring each token is linked to its requirement, architecture, implementation, and test references before retiring the YAML source.
...
- [x] Draft new sections in `tied/semantic-tokens.md` with canonical entries per token, including status, scope, and cross-layer references.
- [x] Append migrated tokens to `tied/semantic-tokens.md` and create alias notes so existing documents retain traceability during the transition.
...
**Completion Criteria**:
- [x] All tokens listed in `project-tokens.yaml` represented in `tied/semantic-tokens.md` with cross-references to requirements, architecture, implementation, tests, and code.
...
**Description**: Add missing semantic tokens to source functions and test functions identified by the token coverage analysis and update `tied/semantic-tokens.md` where new tokens are introduced. Prioritize public APIs and tests.
...
- [x] Update `tied/semantic-tokens.md` with any new tokens created

...
**Split/merge rule:** Feedback artifact vocabulary stays here; MCP general catalog in [`tied-yaml-mcp.md`](tied-yaml-mcp.md).
...
| MCP_HANDLER | Pseudo-code blocks |
| FeedbackType | Naming bridge |

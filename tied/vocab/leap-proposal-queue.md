...
**Traceability:** `REQ-LEAP_PROPOSAL_QUEUE` · `ARCH-LEAP_PROPOSAL_QUEUE` · `IMPL-MCP_LEAP_PROPOSAL_QUEUE` (detail YAML in STDD source repository when absent from this client copy)

**Help coverage:** N/A (no in-app Help in this repository)

**STDD source note:** LEAP proposal queue token detail files may live only in the TIED methodology repository; `leap-proposals/` paths and MCP tool names here remain canonical.
...
**Split/merge rule:** Non-canonical proposal lifecycle here; canonical LEAP stack updates in [`pseudocode-and-citdp.md`](pseudocode-and-citdp.md).

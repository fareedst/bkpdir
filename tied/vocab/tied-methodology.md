...
**Split/merge rule:** TIED layout and PROC tokens stay here; bkpdir product terms in `bkpdir-*.md`; STDD tooling terms in sibling glossaries.
...
| List group sorter | yaml_list_sorter | `scripts/yaml_list_sorter.rb` | `--sort-keys` optional; invoked by yaml_tool `--sort-lists` | [PROC-YAML_EDIT_LOOP](../docs/processes.md) |

...
**Split/merge rule:** MCP tool names stay here; feedback and LEAP proposal tools in sibling glossaries.
...
| tied_config_get_base_path | MCP catalog |
| tied_token_create_with_detail | MCP catalog |
| yaml_detail_create | MCP catalog |
| yaml_detail_update | MCP catalog |
| yaml_index_insert | MCP catalog |
| yaml_index_list_tokens | MCP catalog |
| yaml_updates_apply | MCP catalog |

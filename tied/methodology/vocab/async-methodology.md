...
- Checklist: agent-req-implementation-checklist.md § catalog-async-boundaries, flag-async-contradictions
- Authoring: requirements.md § Async acceptance criteria
- Architecture prompts: architecture-decisions.md § Async architecture decisions
- Grammar: pseudocode-format-and-practices.md § Optional async contract rows
- Plan: tied-async-methodology-plan.md
